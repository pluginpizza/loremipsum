...
To use Lorem Ipsum, there are only two things you need to do: install and activate the plugin. An autocompleter to insert dummy text and placeholder images becomes available in the block editor without any extra configuration. Lorem Ipsum also works great as a [must-use plugin](https://wordpress.org/documentation/article/must-use-plugins/).
...
Do you want to report a bug or suggest a feature for Lorem Ipsum? Best to do so in the [Lorem Ipsum repository on GitHub](https://github.com/pluginpizza/loremipsum/).
...
1. Install and activate Lorem Ipsum - Block Editor Autocomplete from your Plugins page
